...
const StandaloneChat: React.FC<ChatProps> = (
  ...
  if (!user) {
    return (
      <div className='h-screen w-full bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center'>
        <div className='text-center bg-white p-8 rounded-2xl shadow-xl border border-gray-200'>
          <Loader className='w-10 h-10 animate-spin mx-auto mb-4 text-indigo-600' />
  ...
  return (
    <div className='h-screen w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden'>
      ...
      <div className='fixed inset-0 overflow-hidden pointer-events-none'>
        <div className='absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 rounded-full opacity-10 blur-3xl animate-pulse' />
        <div className='absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-blue-400 via-cyan-500 to-emerald-600 rounded-full opacity-10 blur-3xl animate-pulse' />
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-violet-400 to-purple-600 rounded-full opacity-5 blur-3xl animate-pulse' />
      </div>

      <div className='relative h-full flex'>
        {/* Enhanced Conversation List */}
        <div className='w-96 bg-white/95 backdrop-blur-xl shadow-2xl border-r border-gray-200/50 flex flex-col'>
          {/* Enhanced Header */}
          <div className='px-6 py-5 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-white'>
            <div className='flex items-center gap-4 mb-5'>
              ...
              <div>
                ...
                <p className='text-sm text-white/90'>
                  {filteredItems.length} conversation{filteredItems.length !== 1 ? 's' : ''}
                </p>
              </div>
            </div>
            ...
            <div className='relative'>
              ...
              <input
                ...
                className='w-full pl-12 pr-4 py-3 bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50 focus:bg-white/30 transition-all duration-300 text-sm'
              />
            </div>
          </div>
              ...
              filteredItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    className={`p-5 cursor-pointer border-b border-gray-100/50 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 ${
                  ...
                  >
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='relative flex-shrink-0'>
                        <div
                          className={`w-14 h-14 rounded-full flex items-center justify-center text-white font-bold text-base shadow-lg ${
                            item.type === 'recipient'
                        ...
                        {unreadCount > 0 && (
                          <div className='absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-600 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center shadow-lg border-2 border-white'>
        ...
        <div className='flex-1 flex flex-col bg-white/90 backdrop-blur-xl shadow-2xl'>
          {/* Enhanced Header */}
          <div className='px-8 py-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-white flex items-center gap-4 shadow-lg'>
            <div className='w-12 h-12 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/30'>
              <User className='w-6 h-6' />
            </div>
            <div>
          ...
          {isLoading ? (
            <div className='flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white'>
              <div className='flex flex-col items-center gap-4 text-gray-500 bg-white p-8 rounded-2xl shadow-xl border border-gray-200'>
                <Loader className='w-10 h-10 animate-spin text-indigo-600' />
                <p className='text-base font-medium'>Loading messages...</p>
              </div>
            </div>
          ) : (
            <div className='flex-1 overflow-y-auto p-8 space-y-6 bg-gradient-to-br from-gray-50/50 to-white/50'>
              {messages.map((msg) => (
                <div
                  key={msg.id}
                      ...
                      {['student', 'consultant'].includes(user.role) && (
                        <div className='absolute -right-2 top-2 opacity-0 group-hover:opacity-100 transition-all duration-300'>
                          <button
                            ...
                            className='p-2 bg-white shadow-xl rounded-full hover:shadow-2xl transition-all duration-300 text-gray-600 hover:text-blue-600 hover:scale-110 border border-gray-200'
                            title='Reply'
                          >
          ...
          {selectedConversation && (
            <div className='p-8 border-t border-gray-200/50 bg-white/95 backdrop-blur-xl'>
              <form
              ...
              >
                {replyToMessage && (
                  <div className='bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 rounded-xl flex items-center justify-between shadow-sm'>
                    ...
                    <button
                      ...
                      className='text-blue-500 hover:text-blue-700 font-bold text-sm px-4 py-2 rounded-lg hover:bg-blue-100 transition-all duration-200'
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <div className='flex gap-4'>
                  <input
                    ...
                    className='flex-1 px-6 py-4 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 shadow-sm hover:shadow-md text-base'
                  />
                  <input
                    type='file'
                    ref={fileInputRef}
                  ...
                  <button
                    ...
                    className='p-4 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105'
                  >
                    <Paperclip className='w-6 h-6' />
                  </button>
                  <button
                    type='submit'
                    className='px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed font-medium hover:scale-105'
                ...
                {file && (
                  <div className='bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 p-4 rounded-xl shadow-sm'>
